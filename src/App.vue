...
// forces you to maintain list of dependencies manually
...
const register = () => {
  ...
  //rest of registration logic goes here
}
...
//specifically tracks the given fields within the array 
// watchEffect(() => {
//   console.log(wizard1.value.name, wizard1.value.wand.core)
// })

//does not currently get trigger due to not being deep implicitaly
watchEffect(() => {
